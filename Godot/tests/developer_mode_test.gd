...
func run_test() -> void:
	...
	expect(overlay.part_search != null and overlay.part_filter != null and overlay.part_theme_filter != null and overlay.part_grade_filter != null and overlay.part_preview != null, "파트 검색·분류 필터·미리보기 컨트롤")
